function phxex_multisim1
% PHXEX_MULTISIM1 Independent simulations side by side in subplots
%
% Separate phx.Simulation objects run in their own axes with different time
% steps, and the height difference between their bodies is plotted live.
...
%   Copyright 2026 HUMUSOFT s.r.o.
    ...
    % Create a plot for the Z-coordinate difference
    subplot(2, 2, [3 4]);
    L = plot(nan(1, 100), "Color", [1 0 1]);
    title("Z-coordinate difference"); xlim([1 100]); ylim([-1 1]); grid("on");
    ...
    for i = 1:100
        sim1.step(0.01);
        sim2.step(0.01, 1, 1);
        L.YData(i) = A.Position(3) - B.Position(3);
    end
