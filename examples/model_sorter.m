...
%   Copyright 2026 HUMUSOFT s.r.o.
    ...
    Defl = phx.Body("Type", "static", "Position", [6.5 0 1.6], "EulerAngles", [0 0 deg2rad(30)], "Shape", {"Box", "Size", [7 0.4 1.6], "Color", [0.90 0.80 0.30]}, "Friction", [0.4 0 0], "Name", "Defl"); %#ok<NASGU>

    ChuteUp = phx.Body("Type", "static", "Position", [11.5 0 zc(11.5)], "EulerAngles", [0 deg2rad(20) 0], "Shape", {"Box", "Size", [7 9 0.4], "Color", [0.92 0.92 0.92]}, "Friction", [0.05 0 0], "Name", "ChuteUp"); %#ok<NASGU>
    ChuteDn = phx.Body("Type", "static", "Position", [20.75 0 zc(20.75)], "EulerAngles", [0 deg2rad(20) 0], "Shape", {"Box", "Size", [4.5 9 0.4], "Color", [0.92 0.92 0.92]}, "Friction", [0.1 0 0], "Name", "ChuteDn"); %#ok<NASGU>
    Trap = phx.Body("Type", "kinematic", "Position", [16.75 0 zc(16.75)], "EulerAngles", [0 deg2rad(20) 0], "Shape", {"Box", "Size", [3.5 9 0.4], "Color", [0.20 0.80 0.40]}, "Friction", [0.1 0 0], "Name", "Trap"); %#ok<NASGU>
    ...
    EndW   = phx.Body("Type", "static", "Position", [23.2 0 zc(23)+1], "Shape", {"Box", "Size", [0.4 9 3], "Color", [0.85 0.85 0.85]}, "Name", "EndW"); %#ok<NASGU>   % bin B back wall
    BinA   = phx.Body("Type", "static", "Position", [21 0 -8], "Shape", {"Box", "Size", [20 11 0.5], "Color", [1 0.9 0.9]}, "Friction", [0.6 0 0], "Name", "BinA"); %#ok<NASGU>
    BinAbk = phx.Body("Type", "static", "Position", [31 0 -6.5], "Shape", {"Box", "Size", [0.4 11 4], "Color", [1 0.9 0.9]}, "Name", "BinAbk"); %#ok<NASGU>
