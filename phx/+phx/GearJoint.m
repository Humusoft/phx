classdef GearJoint < phx.base.Joint
...
%   Custom direction vectors of rotation axes can be set using AxisA and AxisB
%   properties.
%
%   phx.GearJoint(___, name, value, ...) creates a joint and sets properties
