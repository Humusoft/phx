...
%phx.FixedJoint Fixed joint - UNDER DEVELOPMENT
%
    ...
    methods (Access = protected)
        function valid = initObject(obj, world)
            ...
            if valid
                ...
                tb = eye(4);
                tb(13:15) = obj.PointB;
                obj.ObjectHandle = phx.engine.io('add', world, 'fixedconstraint', obj.Parents{1}.ObjectHandle, obj.Parents{2}.ObjectHandle, ta(:), tb(:));
